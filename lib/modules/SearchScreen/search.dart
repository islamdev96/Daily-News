            ...
            body: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    state is LoadingDuringGettingDataFromApi
                        ? const Text('')
                        : Expanded(
                                    ...
                                    if (mySearch[index]['urlToImage'] != null) {
                                      Navigator.push(context,
                                        ...
                                        return DetailsScreen(
                                            mySearch[index]['title'],
                                            mySearch[index]['urlToImage'],
                                            mySearch[index]['description']);
                                      }));
                                    }
                                  },
                                  child: Container(
